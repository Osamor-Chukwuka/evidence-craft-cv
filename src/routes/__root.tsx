  ...
  head: () => ({
    meta: [
      ...
      { title: "Commit Trail — Evidence-backed developer CVs" },
      {
        name: "description",
        content:
          "Turn your real GitHub history into an evidence-backed CV. Sync commits and PRs, review your work, and generate resume bullets you can prove.",
      },
      { property: "og:title", content: "Commit Trail — Evidence-backed developer CVs" },
      {
        property: "og:description",
        content: "Sync your GitHub work, review it, and build a CV backed by real commits.",
      },
